    ...
    <RegistContainer>
      ...
      <RegistContents>
        ...
        <SmallContainer>
          ...
          <RegistPageButton
            onPress={() => {
              IDonTextChanged(userid);
            }}
            text="확인"></RegistPageButton>
        </SmallContainer>
        ...
        <SmallContainerForMiddlePicker>
          ...
          <RegistDatePicker
            text={`${fullDate.split('-')[0]} ▼`}></RegistDatePicker>
          <RegistDatePicker
            text={`${fullDate.split('-')[1]} ▼`}></RegistDatePicker>
          <RegistDatePicker
            text={`${fullDate.split('-')[2]} ▼`}></RegistDatePicker>
            */}
        </SmallContainerForMiddlePicker>
        ...
        <SmallContainerForBottomButton>
          <RegistPageButton
            ...
            text="취소"></RegistPageButton>
          <RegistButton
            onPress={() => {
              store();
            }}
            text="가입"></RegistButton>
        </SmallContainerForBottomButton>
