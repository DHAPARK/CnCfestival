...
function saveLocation(name) {
  if (name === '미래관') {
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.58263272, longitude: 127.01069909}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.582638, longitude: 127.010081}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.58348455, longitude: 127.00921792}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.58230697, longitude: 127.0098273}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.581841, longitude: 127.009851}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.581577, longitude: 127.009554}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.58157236, longitude: 127.00981972}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.58214165, longitude: 127.0113248}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.583005, longitude: 127.009557}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.583049, longitude: 127.010657}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.5821, longitude: 127.0108}),
      err => {
        if (err) {
          return false;
        } else {
    ...
    AsyncStorage.setItem(
      'SearchLocationInfo',
      JSON.stringify({latitude: 37.58241, longitude: 127.009715}),
      err => {
        if (err) {
          return false;
        } else {
