    ...
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          options={{ title: "결제 화면1", headerShown: false }}
        />
        <Stack.Screen
          name="PaymentOneTwo"
          component={PaymentOneTwo}
          options={{ title: "결제 화면 1-2", headerShown: false }}
        />
        <Stack.Screen
          name="PaymentOneThree"
          component={PaymentOneThree}
          options={{ title: "결제 화면 1-3", headerShown: false }}
        />
        <Stack.Screen
          name="RemittanceOne"
          component={RemittanceOne}
          options={{ title: "송금 화면 1", headerShown: false }}
        />
        <Stack.Screen
          name="RemittanceOneTwo"
          component={RemittanceOneTwo}
          options={{ title: "송금 화면 2", headerShown: false }}
        />
        <Stack.Screen
          name="RemittanceOneThree"
          component={RemittanceOneThree}
          options={{ title: "송금 화면 3", headerShown: false }}
        />
        <Stack.Screen
          name="TransactionAni"
        ...
        <Stack.Screen
          ...
          options={{ title: "정보 수정", headerShown: false }}
        />
        ...
        <Stack.Screen
          ...
          options={{ title: "가맹점", headerShown: false }}
        />
        <Stack.Screen
          name="UsageHistory"
          component={UsageHistory}
          options={{ title: "이용내역", headerShown: false }}
        />

        <Stack.Screen
          name="UserInfo"
          component={UserInfo}
          options={{ title: "유저 정보 화면", headerShown: false }}
        />
        <Stack.Screen
          name="ExpoCamera"
          component={ExpoCamera}
          options={{ title: "QR코드 스캔", headerShown: false }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
